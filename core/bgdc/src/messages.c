...
#define MSG_LIBRARY_NOT_FOUND           "Libraria \"%s\" no encontrada"
...
#define MSG_OPTIONS                     "   -o ouputfile    Fichero DCB a generar\n" \
                                        "   -i dir          Anade ese directorio al PATH\n" \
                                        ...
                                        "   -D macro=texto  Define una macro\n\n" \
                                        "   -p|--pedantic   No usar declaraciones automaticas\n" \
                                        "   -C options      Especifica opciones de compilacion\n" \
                                        "                   Donde opciones es:\n" \
                                        "                   a    Habilita declaraciones automaticas de funciones\n" \
...
#define MSG_COMPILE_ERROR               "%s:%d: error: %s "
#define MSG_COMPILE_WARNING             "%s:%d: advertencia: %s "
...
#define MSG_VARIABLE_REDECLARE          "Variable ya declarada"
#define MSG_VARIABLE_REDECLARE_DIFF     "Variable ya declarada con diferente tipo"
#define MSG_IDENTIFIER_EXP              "Se esperaba identificador"
...
#define MSG_NO_COMPATIBLE_DLL           "La libreria no es compatible BennuGU"
...
#define MSG_MACRO_ERROR                 "Macro %s ya fue declarada"
#define MSG_OR                          " o "
#define MSG_TOO_COMPLEX                 "Expresion demasiado compleja"
#define MSG_EXTRA_CHAR                  "Caracter demas"
#define MSG_INVALID_EXP                 "Expresion invalida"
#define MSG_FILENAME_EXP                "Se esperaba un nombre de fichero"

#define MSG_ON_PARAM_ERR                "Se esperaba comando ERROR/EXIT"
#define MSG_GOTO_EXP                    "Se esperaba GOTO/JMP"
#endif
*/
