...
OPEN2X=~/wizdev/openwiz/toolchain/arm-openwiz-linux-gnu
...
BUILD=`uname -m`
PKG_CONFIG_PATH=~/wizdev/openwiz/toolchain/arm-openwiz-linux-gnu/lib/pkgconfig
...
ln -s `whereis -b pkg-config | sed 's/pkg-config\: //g'` ~/wizdev/openwiz/toolchain/arm-openwiz-linux-gnu/bin/pkg-config
